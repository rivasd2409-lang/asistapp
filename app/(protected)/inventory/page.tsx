          ...
          {data.inventoryItems.map(
            (item: typeof data.inventoryItems[number]) => {
              ...
              return (
                ...
                >
                  <p>
                    <strong>Medicamento:</strong> {item.medicationName}
                  </p>
                  <p>
                    <strong>Paciente:</strong> {item.patient.name}
                  </p>
                  <p>
                    <strong>Stock:</strong>{" "}
                  ...
                  {canUpdateInventory ? (
                    <details className="mt-3 rounded border border-white/10 bg-black/20 p-3">
                      ...
                      <form
                        action={updateMedicationInventoryItem}
                      ...
                      >
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                          ...
                          <div>
                            ...
                            >
                              {data.patients.map(
                                (patient: typeof data.patients[number]) => (
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <p className="text-sm text-white/55">
                            Si ya existe otro registro con el mismo paciente y
                            medicamento, no se guardará el cambio.
                          </p>
                        </div>
                      </form>
                    </details>
